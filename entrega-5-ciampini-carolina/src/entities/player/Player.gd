...
@export var acceleration: float = 3600.0 # La aceleración se calcula por frame usando delta.
@export var h_speed_limit: float = 290.0
@export var jump_speed: int = 500
@export var friction_weight: float = 6.0
